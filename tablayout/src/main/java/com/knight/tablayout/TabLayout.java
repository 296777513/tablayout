...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray aExtend = context.obtainStyledAttributes(attrs, com.knight.tablayout.R.styleable.TabLayout_Extend);

        mIndicatorAnimation = aExtend.getBoolean(com.knight.tablayout.R.styleable.TabLayout_Extend_tabIndicatorAnimation, false);
    ...
    private void updateTabViewLayoutParams(LinearLayout.LayoutParams lp) {
        if (mMode == MODE_FIXED && mTabGravity == GRAVITY_FILL) {
            ...
            lp.width = mTabItemWidth == 0 ? LinearLayout.LayoutParams.WRAP_CONTENT : mTabItemWidth;
            lp.weight = 0;
        }
    }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                ...
                if (mSelectedIndicatorWidth > 0 && getSelectedTabPosition() >= 0 &&
                        (!TabLayout.this.mIndicatorFullWidth || (mSelectedIndicatorWidth <= minTabWidth))
                ) {
        ...
        private int getWrapContentIndicatorWidth(int index) {
            ...
            mWidthList.clear();
            if (!TabLayout.this.mIndicatorFullWidth && getChildAt(index) != null) {
                ...
                if (childAt instanceof TabView) {
                    ...
                    int diffent = childAt.getMeasuredWidth() - width;
                    width += diffent * mIndicatorWidthPercent;
                } else {
                    width = childAt.getMeasuredWidth() - mTabPaddingStart - mTabPaddingEnd;
                }
            }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            if (tabLayout != null) {
                ...
                if (tabLayout.mIndicatorAnimation) {
    ...
    public boolean isIndicatorAnimation() {
        return mIndicatorAnimation;
    }

    public void setIndicatorAnimation(boolean IndicatorAnimation) {
        mIndicatorAnimation = IndicatorAnimation;
    }
